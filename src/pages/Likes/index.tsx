...
import { Like } from '@data-types/api';
...
const Likes = () => {
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500 pb-12">
            <h2 className="text-2xl font-bold text-foreground font-outfit">Interaction Signals (Likes)</h2>
                    ...
                    <tbody className="divide-y divide-border">
                        {likes.map((rel) => (
                            <tr key={rel.id} className="hover:bg-rose-50/30 transition-colors">
                                ...
                                <td className="px-6 py-5 text-xs text-muted-foreground">{formatDate(rel.created_at)}</td>
