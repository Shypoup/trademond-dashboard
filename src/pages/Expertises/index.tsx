        ...
        <SheetContent className="w-full max-w-lg overflow-y-auto border-border sm:max-w-lg">
          ...
          <form onSubmit={(e) => void handleSubmit(e)} className="space-y-4">
            <div className="space-y-2">
              <label className="text-[11px] font-bold uppercase tracking-wide text-muted-foreground">{t('expertisesPage.category')}</label>
              <select
                required
            ...
            <div className="space-y-2">
              <label className="text-[11px] font-bold uppercase tracking-wide text-muted-foreground">{t('expertisesPage.isicOptional')}</label>
              <input
